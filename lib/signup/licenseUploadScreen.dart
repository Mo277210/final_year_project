  ...
  void _submitImage() {
    if (_selectedFile == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text("Please select an image before submitting."),
      ...
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text(
                'We have received your details and will contact you via email once your registration is approved.'),
            actions: [
              TextButton(
